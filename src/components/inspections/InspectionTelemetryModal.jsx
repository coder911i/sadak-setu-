      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3.5 rounded-xl bg-white border border-[#e2ebe4] shadow-sm space-y-1">
            ...
            <p className="text-[10px] text-slate-500 font-mono">Area: {defect.dimensions.areaSqM} m²</p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-[#e2ebe4] shadow-sm space-y-1">
            ...
            <div className="text-2xl font-bold font-mono text-rose-600">
              {defect.sensorVibrationG} <span className="text-xs text-slate-500 font-normal">G</span>
            </div>
            <p className="text-[10px] text-slate-500">Normal Baseline: &lt; 0.8G</p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-[#e2ebe4] shadow-sm space-y-1">
            ...
            <div className="text-2xl font-bold font-mono text-brand-600">
              {defect.estimatedPatchVolumeKg} <span className="text-xs text-slate-500 font-normal">KG</span>
            </div>
            <p className="text-[10px] text-slate-500">Ready Polymer Mix</p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-[#e2ebe4] shadow-sm space-y-1">
            ...
            <div className="text-2xl font-bold font-mono text-slate-900">
              {defect.riskScore}<span className="text-xs text-slate-500">/100</span>
            </div>
        ...
        <div className="p-4 rounded-xl bg-white border border-[#e2ebe4] shadow-sm space-y-2 text-xs">
          <div className="flex items-center justify-between">
            <span className="font-semibold text-slate-800">AI Diagnostic Summary:</span>
            <span className="text-slate-500 flex items-center gap-1">
              <Sun className="w-3.5 h-3.5 text-amber-500" /> {defect.weatherCondition}
            </span>
          </div>
          <p className="text-slate-700 leading-relaxed bg-[#f8faf8] p-3 rounded-lg border border-[#e2ebe4]">
            {defect.notes}
          </p>
        </div>
      </div>
