      ...
      <CardContent className="p-0 divide-y divide-line flex-1 overflow-y-auto">
        {activeOrders.map((wo) => {
          const statusMeta = WORK_ORDER_STATUSES[wo.status.toUpperCase()] || {
            label: wo.status,
            color: 'bg-surface-100 text-ink-700',
          };
          ...
          return (
            <div
              ...
              className="p-3.5 hover:bg-surface-100 transition-colors space-y-2 cursor-pointer group"
            >
              <div className="flex items-start justify-between gap-2">
                <div className="space-y-0.5 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-ink-500 font-mono text-[11px]">({wo.roadCode})</span>
                  </div>
                  <h5 className="text-xs font-semibold text-ink-900 truncate group-hover:text-brand-700 transition-colors">
                    {wo.title}
                  </h5>
                </div>
              ...
              <div className="space-y-1 pt-1">
                <div className="flex items-center justify-between text-[11px] text-ink-500">
                  ...
                  <span className="font-mono text-ink-700">{wo.progressPercentage}%</span>
                </div>
                <ProgressBar
              ...
              {/* SLA & Budget info */}
              <div className="flex items-center justify-between text-[10px] text-ink-400 font-mono pt-0.5">
