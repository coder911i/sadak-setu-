  ...
  return L.divIcon({
    ...
    html: `
      <div class="relative flex items-center justify-center w-5 h-5">
        <div class="w-3.5 h-3.5 rounded-full border-2 border-slate-900 shadow-md" style="background-color: ${color}"></div>
      </div>
    `,
    iconSize: [20, 20],
    iconAnchor: [10, 10],
          ...
          >
            <Popup>
              <div className="p-2 space-y-1 text-xs">
                <span className="font-mono font-bold text-white">{road.code}</span>
                <p className="text-slate-300">{road.name}</p>
                <div className="text-[11px] text-slate-400 font-mono">
                  Health: <strong className="text-emerald-400">{road.healthScore}/100</strong>
                </div>
              </div>
            </Popup>
          </Polyline>
              ...
              <Popup>
                <div className="p-2 space-y-1 text-xs">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[9px] font-mono uppercase bg-rose-950 text-rose-300 px-1 rounded">
                      {defect.severity}
                    </span>
                  </div>
                  <div className="text-slate-300 font-mono">{defect.chainage}</div>
